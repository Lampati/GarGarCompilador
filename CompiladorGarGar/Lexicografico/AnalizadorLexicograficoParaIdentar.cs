...
{
    //Esta clase no funciona para el compilador. Sirve unicamente para identar el codigo
    class AnalizadorLexicograficoParaIdentar : AnalizadorLexicografico
    {
        private string texto;       
     
        //Inicializo lo estrictamente necesario. Creo el buffer a partir del archivo y el AFD a partir de otro archivo
        public AnalizadorLexicograficoParaIdentar()
            : base()
        {
